...
static int access_hit_data_cb(uint16_t conn_handle, uint16_t attr_handle,
                               ...
                               struct ble_gatt_access_ctxt *ctxt, void *arg)
{
    ...
    ESP_LOGI(BLE_SVCS_TAG, "UUID 0x%04x", uuid);
